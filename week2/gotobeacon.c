...
#pragma config(Sensor, dgtl1,  beaconswitch,   sensorDigitalIn)
	...
	while(true){
		switch (phase) {
			...
			case PHASE_REVERSE_RED:
				...
				break;
			case PHASE_GOTO_GREEN: // TODO: figure out how to lock onto green beacon
				phase = PHASE_RETURN_HOME;
				ReadPD();
				Find_max();
				Move();
				if (SensorValue[beaconswitch]) phase = PHASE_RETURN_HOME;
				break;
